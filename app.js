...
app.post("/login", async(req,res)=>{
    var strUsermail=req.body.usermail; // getting the value sent by the form especially text: username
    var strPassword=req.body.password;// getting the value sent by the form especially text: password
    try{
        var userFound= await userModel.findOne({usermail:strUsermail});//find the user wit that 
